...
public class NPC_ForestShaman : MonoBehaviour
{
    [SerializeField] int NPC_Number = 49;
    ...
    [Space]
    [SerializeField] ShamanEncounterController enCtrlr;
    ...
    private void OnEnable()
    {
        ...
        if (enCtrlr == null)
        {
            enCtrlr = FindObjectOfType<ShamanEncounterController>();
        }
    }
    void Start()
    {
    ...
    private void Update()
    {
        ...
        if (QuestTracker.forestQuestCount == 1 && !QuestTracker.fQ2_Item1  && !QuestTracker.fQ2_Item2 && !QuestTracker.fQ2_Item3)
        {
            QuestTracker.allTotemsCollected = true;
        }
        ...
        if (touchingPlayer == true && Input.GetKeyDown(KeyCode.Z))
        {
            ...
            else if (QuestTracker.forestQuestCount == 0)
            {
                enCtrlr.SpeakWithShaman();
            }

            else if (QuestTracker.forestQuestCount == 1 && QuestTracker.allTotemsCollected)
            {
                enCtrlr.SpeakWithShaman2();
            }
            
            else if (QuestTracker.forestQuestCount == 3)
            {
                enCtrlr.SpeakWithShaman3();
            }

            else if (QuestTracker.forestQuestCount >= 4)
            {
                enCtrlr.SpeakWithShaman4();
            }
        }
        
        if (QuestTracker.forestQuestCount == 0) // first interaction in town
        {
            NPC_Number = 49;
        }
        ...
        else if (QuestTracker.forestQuestCount == 1 && QuestTracker.allTotemsCollected) // if you speak with her with totems collected(starting protect Q)
        {
            NPC_Number = 51;
        }
        
        else if (QuestTracker.forestQuestCount == 2) // if you speak with her while she is dispelling poison
        {
            NPC_Number = 52;
        }
        
        else if (QuestTracker.forestQuestCount == 3) // if you speak with her after dispelling posion (go fight boss line)
        {
            NPC_Number = 53;
        }
