...
public class NPC_DesertStranded0 : MonoBehaviour
{
    ...
    {
        if (this.gameObject.transform.position.x == playerTarget.position.x - 1 && this.gameObject.transform.position.y == playerTarget.position.y)
        {
        ...
        {
            this.gameObject.transform.position = Vector3.MoveTowards(this.gameObject.transform.position, new Vector3(playerTarget.position.x - 1, playerTarget.position.y, 0), 5f * Time.fixedDeltaTime);
