...
public class NPC_GLelder : MonoBehaviour
{
    [SerializeField] int NPC_Number = 6;
    ...
    [Space]
    [SerializeField] ElderEncounterController enCtrlr;
    ...
    private void OnEnable()
    {
        ...
        if (enCtrlr == null)
        {
            enCtrlr = FindObjectOfType<ElderEncounterController>();
        }
    }
    void Start()
    {
    ...
    private void Update()
    {
        if (touchingPlayer == true && Input.GetKeyDown(KeyCode.Z))
        {
            ...
            {
                enCtrlr.SpeakWithElder();
            }

            else if (QuestTracker.grasslandsQuestCount == 3)
            {
                enCtrlr.SpeakWithElder2();
            }

            else if (QuestTracker.grasslandsQuestCount >= 6 && QuestTracker.desertQuestCount < 5)
            {
                enCtrlr.SpeakWithElder3();
            }

            else if (QuestTracker.desertQuestCount >= 5)
            {
                enCtrlr.SpeakWithElder4();
            }
        }
        ...
        else if (QuestTracker.grasslandsQuestCount == 2)
        {
            NPC_Number = 7;
        }
