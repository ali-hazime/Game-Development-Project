...
public class NPC_Chief : MonoBehaviour
{
    public int NPC_Number = 65;
    ...
    [Space]
    [SerializeField] SnowGameController enCtrlr;
    ...
    private void OnEnable()
    {
        ...
        if (enCtrlr == null)
        {
            enCtrlr = FindObjectOfType<SnowGameController>();
        }
    }
    void Start()
    {
    ...
    private void Update()
    {
        ...
        if (touchingPlayer == true && Input.GetKeyDown(KeyCode.Z))
        {
            ...
            if (QuestTracker.snowMountainQuestCount == 0)
            {
                ...
                StartCoroutine(AcceptTowerQuest());
            }
        }
    }

    IEnumerator AcceptTowerQuest()
    {
