...
public class LeaveEnchanter : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D thing)
    {
        if (thing.CompareTag("Player"))
        {
            ...
            GameSavingInformation.whereAmI = GameSavingInformation.whereWasI;
            SceneManager.LoadScene(GameSavingInformation.whereWasI);
            GameSavingInformation.playerX = GameSavingInformation.tempPlayerX;
            GameSavingInformation.playerY = GameSavingInformation.tempPlayerY;
