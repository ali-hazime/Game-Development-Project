...
public class ToEnchanter : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D thing)
    {
        ...
        {
            GameSavingInformation.whereAmI = "Enchanter";
            ...
            GameSavingInformation.playerY = 0f;
            GameSavingInformation.tempPlayerX = player.transform.position.x;
            GameSavingInformation.tempPlayerY = player.transform.position.y - 1;
